...
class TestSmokeTest():
  ...
  def test_test4(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Travolta")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Face")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Off")
